...
const HeroSection = () => {
  ...
  return (
    <div className="flex items-center justify-center bg-theme-primary p-4">
      <div className="grid w-full max-w-5xl grid-cols-1 overflow-hidden rounded-2xl border border-theme bg-theme-secondary shadow-2xl lg:grid-cols-2 lg:h-[500px]">
